---
title: ProSport — Blueprint Original
tags:
  - prosport
  - historico
---

> [!quote] Spec original do produto
> Gerado pelo Firebase Studio no início do projeto — visão e guia de estilo originais. Referenciado em [[CLAUDE#2.3 Árvore de pastas anotada|CLAUDE.md §2.3]]. Trate como histórico: confira [[CLAUDE]] para o estado atual do produto.

# **App Name**: ProSport Portfolio
