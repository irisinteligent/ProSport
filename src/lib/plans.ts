...
export const PLAN_DETAILS: Record<PlanId, PlanDetails> = {
  basic: { id: "basic", name: "Básico", role: "athlete", monthlyPriceCents: 990, annualPriceCents: 9990 },
  plus: { id: "plus", name: "Plus", role: "athlete", monthlyPriceCents: 2990, annualPriceCents: 29990 },
  premium: { id: "premium", name: "Premium", role: "athlete", monthlyPriceCents: 5990, annualPriceCents: 59990 },
